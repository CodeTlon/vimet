...
export default function TurnoCanceladoProfesionalEmail({
  nombreProfesional,
  pacienteNombre,
  fecha,
  horaInicio,
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>Turno cancelado por {pacienteNombre}</Preview>
      <Tailwind>
          ...
          >
            ...
            <Section style={{ padding: '28px 32px 8px' }}>
              <Text style={{ margin: 0, fontSize: 14, color: '#4A4A4A' }}>
                ...
                <strong style={{ color: DARK }}>{pacienteNombre}</strong> canceló su turno.
              </Text>
            </Section>
