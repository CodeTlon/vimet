...
export default function TurnoCanceladoStaffEmail({
  nombre,
  fecha,
  horaInicio,
  horaFin,
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>Tu turno fue cancelado</Preview>
      <Tailwind>
          ...
          >
            ...
            <Section style={{ padding: '28px 32px 8px' }}>
              <Text style={{ margin: 0, fontSize: 14, color: '#4A4A4A' }}>
                Hola <strong style={{ color: DARK }}>{nombre}</strong>, el equipo canceló tu turno.
              </Text>
            </Section>
            ...
            >
              ...
              {motivo ? (
                ...
                >
                  <strong style={{ color: DARK }}>Motivo:</strong> {motivo}
                </Text>
              ) : null}
            </Section>
