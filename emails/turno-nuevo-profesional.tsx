...
export default function TurnoNuevoProfesionalEmail({
  nombreProfesional,
  pacienteNombre,
  fecha,
  horaInicio,
  ...
  return (
    <Html lang="es">
      <Head />
      <Preview>Nuevo turno reservado por {pacienteNombre}</Preview>
      <Tailwind>
          ...
          >
            ...
            <Section style={{ padding: '28px 32px 8px' }}>
              <Text style={{ margin: 0, fontSize: 14, color: '#4A4A4A' }}>
                Hola <strong style={{ color: DARK }}>{nombreProfesional}</strong>,{' '}
                <strong style={{ color: DARK }}>{pacienteNombre}</strong> reservó un turno con vos.
              </Text>
            </Section>
            ...
            >
              ...
              {notas ? (
                ...
                >
                  <strong style={{ color: DARK }}>Notas del paciente:</strong> {notas}
                </Text>
              ) : null}
            </Section>
